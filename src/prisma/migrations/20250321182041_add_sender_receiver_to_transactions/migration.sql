...
INSERT INTO "new_Transaction" ("amount", "createdAt", "id", "reason", "siteBalanceId", "transactionTypeId", "type", "updatedAt", "userId") SELECT "amount", "createdAt", "id", "reason", "siteBalanceId", "transactionTypeId", "type", "updatedAt", "userId" FROM "Transaction";
